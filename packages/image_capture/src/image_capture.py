...
from std_msgs.msg import String  # saving directory
...
class ImageCaptureNode(Node):
    def __init__(self):
        ...
        self.trigger_subscription = self.create_subscription(String, "/capture_trigger", self.trigger_callback, 10)
    ...
    def trigger_callback(self, msg):
        ...
        save_path = msg.data  # image directory from trigger
        ...
        if save_complete:
            ...
            self.get_logger().info(
                f"Fehler beim Speichern des Bildes {self.image_counter +1}!\nAufnahme wird erneut gestartet.")
